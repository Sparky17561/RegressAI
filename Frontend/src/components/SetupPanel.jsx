...
const SetupPanel = ({
  ...
  useEffect(() => {
    if (selectedVersion?.inputs) {
      setFormData(prev => ({
        ...prev,
        oldApi: selectedVersion.inputs.old_api || prev.oldApi,
        newApi: selectedVersion.inputs.new_api || prev.newApi,
        envVars: selectedVersion.inputs.env || prev.envVars,
        bodyTemplate: selectedVersion.inputs.body_template || prev.bodyTemplate,
        responsePath: selectedVersion.inputs.response_path || prev.responsePath,
        numCases: selectedVersion.inputs.n_cases || prev.numCases,
        goal: selectedVersion.inputs.goal || prev.goal,
        oldPrompt: selectedVersion.inputs.old_prompt || prev.oldPrompt,
        newPrompt: selectedVersion.inputs.new_prompt || prev.newPrompt
      }));
    }
  }, [selectedVersion]);
  ...
  const handleRunAnalysis = async () => {
    ...
    try {
      const inputs = {
        ...
        manual_questions: formData.questionsManual 
      ...
      <div className="panel-header">
        ...
        <div className="collaboration-bar">
          <div className="team-section">
            ...
            // In the team-avatars section (around line 154):
        ...
        <div className="section">
          ...
          <div className="input-grid">
            ...
            <div className="input-group">
              ...
              />
              <div className="input-hint">
                {isPremium ? 'Up to 50 cases' : 'Max 10 cases'}
              </div>
            </div>
          </div>
        </div>
